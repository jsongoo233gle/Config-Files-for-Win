...
;; enable recentf-mode(1 or t: enable)
(recentf-mode 1)
...
;; open dired of current buffer, press `C-x C-j` to jump to the dired buffer of current file
(require 'dired-x)
...
;; improve occur, dwim = do what  i mean.
(defun occur-dwim ()
...
(dolist (mode
	 '(flycheck-error-list-mode git-rebase-mode))
